  ...
  return (
    <>
      ...
      <div className='grid'> 
        ...
        <div className='card'>
          <Card indice = {api[0].indice} titulo = {api[4].titulo} url = {api[4].url}/>
        ...
        <div className='card'>
          <Card indice = {api[0].indice} titulo = {api[3].titulo} url = {api[0].url}/>
            <div className='cargaContainer'>
              <CargaLlena  texto= {api[0].carga1} />
        ...
        <div className='card'>
          <Card indice = {api[0].indice} titulo = {api[2].titulo} url = {api[6].url}/>
            <div className='cargaContainer'>
              <Carga3Barras  texto= {api[0].carga1} />
              <Carga1Barra texto= {api[0].carga2}  />
              <Carga4Barras texto={api[0].carga3}   />
              <Carga3Barras texto= {api[0].carga4}  />
              <CargaLlena texto= {api[0].carga5}  />
            </div> 
        </div>

        <div className='card'>
          <Card indice = {api[0].indice} titulo = {api[1].titulo} url = {api[2].url}/>
            <div className='cargaContainer'>
              <Carga3Barras  texto= {api[0].carga1} />
              <Carga1Barra texto= {api[0].carga2}  />
              <Carga4Barras texto={api[0].carga3}   />
        ...
        <div className='card'>
          <Card indice = {api[0].indice} titulo = {api[6].titulo} url = {api[3].url}/>
            <div className='cargaContainer'>
              <CargaLlena  texto= {api[0].carga1} />
        ...
        <div className='card'>
          <Card indice = {api[0].indice} titulo = {api[5].titulo} url = {api[5].url}/>
            <div className='cargaContainer'>
              <CargaLlena  texto= {api[0].carga1} />
              <Carga1Barra texto= {api[0].carga2}  />
              <Carga4Barras texto={api[0].carga3}   />
