  ...
  return (
    <>
      ...
      <div className='grid'> 
        ...
        <div className='card'>
            <Card indice = {api[1].indice} titulo = {api[2].titulo} url = {api[1].url} />
            <div className='cargaContainer'>
                <CargaLlena  texto= {api[0].carga1} />
        ...
        <div className='card'>
            <Card indice = {api[2].indice} titulo = {api[1].titulo} url = {api[2].url} />
        ...
        <div className='card'>
            <Card indice = {api[3].indice} titulo = {api[4].titulo} url = {api[3].url} />
        ...
        <div className='card'>
            <Card indice = {api[4].indice} titulo = {api[6].titulo} url = {api[4].url} />
